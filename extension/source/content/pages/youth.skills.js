...
class YouthSkillsPage extends YouthPage {
	...
	extract(doc, data) {
		...
		HtmlUtil.getTableRowsByHeader(doc, ...YouthSkillsPage.HEADERS)
	...
	fixCountryHeader(doc) {
		...
		let headerRow = HtmlUtil.getTableByHeader(doc, ...YouthSkillsPage.HEADERS).rows[0];
		...
		YouthSkillsPage.HEADERS.splice(0, 0, 'Flag');
		...
		YouthSkillsPage.HEADERS.splice(2, 0, '');
	...
	extend(doc, data) {
		...
		this.table = HtmlUtil.getTableByHeader(doc, ...YouthSkillsPage.HEADERS);
